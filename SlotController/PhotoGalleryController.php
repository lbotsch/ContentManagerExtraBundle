...
namespace Lubo\ContentManagerExtraBundle\SlotController;
...
class PhotoGalleryController extends ContainerAware implements SlotControllerInterface
{
    /**
    ...
    public function renderEditor()
    {
        return $this->container->get('templating')
            ->renderResponse('LuboContentManagerExtraBundle:Slot:photo_gallery_editor.js.twig', array(
